...
def status_abierta_get():
    ...
    postulacion = Postulaciones.query.filter_by(user_id=current_user, postulation_state="abierta").count()
...
def status_en_proceso_get():
    current_user = get_jwt_identity()
    postulacion = Postulaciones.query.filter_by(user_id=current_user, postulation_state="en proceso").count()
...
def status_entrevista_get():
    current_user = get_jwt_identity()
    postulacion = Postulaciones.query.filter_by(user_id=current_user, postulation_state="entrevista").count()
...
def status_oferta_get():
    current_user = get_jwt_identity()
    postulacion = Postulaciones.query.filter_by(user_id=current_user, postulation_state="oferta").count()
...
def status_descartado_get():
    current_user = get_jwt_identity()
    postulacion = Postulaciones.query.filter_by(user_id=current_user, postulation_state="descartado").count()
...
def status_aceptada_get():
    current_user = get_jwt_identity()
    postulacion = Postulaciones.query.filter_by(user_id=current_user, postulation_state="aceptada").count()
